...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 203, -1));
        ...
        getContentPane().add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 203, -1));
        ...
        getContentPane().add(txtNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 203, -1));
        ...
        getContentPane().add(txtNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 203, -1));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert= String.format("INSERT INTO Empleados (ID, Nombre, Correo, Telefono)"
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        if(evt.getClickCount()==1){
            ...
            btnAgregar.setText(receptor.getModel().getValueAt(receptor.getSelectedRow(), 0).toString());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit= String.format("UPDATE Empleados SET Nombre='%s',"
                + "Correo='%s' WHERE ID = %d ", oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getID(), oEmpleados.getTelefono());
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Object[] oUsuario={resultado.getString("ID"),resultado.getString("Nombre"),resultado.getString("Correo"), resultado.getString("Telefono")};
    ...
    public empleadosBL recuperarDatosGUI(){
        ...
        int ID = (btnAgregar.getText().isEmpty())?0: Integer.parseInt(btnAgregar.getText());
